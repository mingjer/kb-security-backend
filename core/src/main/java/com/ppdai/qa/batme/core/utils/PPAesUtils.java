...
@Slf4j
public class PPAesUtils {

    private static final String BATME_AES_KEY = "123456";
    ...
    public static String encodeAES(String input) {
        return doAES(input, BATME_AES_KEY, Cipher.ENCRYPT_MODE);
    }
    ...
    public static String decodeAES(String input) {
        return doAES(input, BATME_AES_KEY, Cipher.DECRYPT_MODE);
    }
